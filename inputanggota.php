...
include("config.php");
  if (isset($_POST['simpan']) ) {
	...
	if (mysqli_num_rows($check) > 0){
		...
		$inputanggota	="INSERT INTO anggota (username, nama, nik, tgl_lahir, jenis_kelamin, pekerjaan, alamat, email, no_hp)
		VALUES ('$username', '$nama','$nik','$tgl_lahir','$jenis_kelamin','$pekerjaan','$alamat','$email','$no_hp')";
        $queryanggota =mysqli_query($conn, $inputanggota);

        $inputuser	="INSERT INTO users (username,password,akses) VALUES ('$username' ,'$password','$akses')";
